		...
		<div class="header-body">
			<div class="container beta-relative">
				...
				<div class="pull-right beta-components space-left ov">
					...
					<div class="beta-comp">
						<!-- <button class="btn btn-primary"><a href="" style="color:white;">Đăng kí</a></button>
						<button class="btn btn-success"><a href="" style="color:white;">Đăng Nhập</a></button> -->
			...
			<div class="container">
				...
				<nav class="main-menu">
					<ul class="l-inline ov">
						...
						<li><a href="index.html">Danh mục sản phẩm</a>
							
							<ul class="sub-menu">
								<li><a href="product_type.html">Sản phẩm 1</a>
								   <ul class="sub-menu">
					                    <li><a href="product.html">sản phẩm 1.1</a></li>
					                    <li><a href="product.html">sanr phẩm 1.2</a></li>
					                    <li><a href="product.html">sản phẩm 1.3</a></li>
					                </ul>
								</li>
