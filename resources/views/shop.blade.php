...
<div class="container">
    <div class="row content">
        ...
        <div class="col-sm-9">
            <a href="{{ url('user/shop/'.Auth::user()->id.'/create') }}" class="btn btn-warning btn-sm pull-left"><span class="glyphicon glyphicon-plus"></span> Thêm một shop mới</a><br>
            <hr>
            <div class="row">
                <!-- Advanced Tables -->                    
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td class="text-center">
                                        <a href="" class="btn btn-info btn-sm pull-right"><span class="glyphicon glyphicon-book"></span> Xem chi tiết </a>
