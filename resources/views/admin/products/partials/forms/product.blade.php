    <div class="container">
        <div class="form-group">
            ...
            <div class="form-conrols">
                {!! Form::text('name', null, ['class' => 'form-control']) !!} <span class="er">This field is required</span>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="form-conrols">
                {!! Form::text('alias', null, ['class' => 'form-control']) !!} <span class="er">This field is required</span>
            </div>
        </div>
    </div>
